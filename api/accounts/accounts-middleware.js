...
exports.checkAccountPayload = (req, res, next) => {
  ...
  console.log(requestTrimmed.length)
  if(!req.body){
    ...
    if (requestTrimmed.length < 3 || requestTrimmed.length > 100){return res.status(400).json({message:"name of account must be between 3 and 100"})
  }
